...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Valdir Cezar", "431.131.740-90", "valdir@mail.com", "123");
		tec1.addPerfil(Perfil.ADMIN);
		Tecnico tec2 = new Tecnico(null, "Gabriel Turatti", "250.795.940-12", "gabriel@mail.com", "456");
		tec2.addPerfil(Perfil.ADMIN);
		Tecnico tec3 = new Tecnico(null, "Carlos Eduardo", "466.317.430-28", "eduardo@mail.com", "223");
		tec3.addPerfil(Perfil.ADMIN); 
		Tecnico tec4 = new Tecnico(null, "João Sousa", "757.632.180-60", "joao@mail.com", "564");
		tec4.addPerfil(Perfil.ADMIN);
		
		Cliente cli1 = new Cliente(null, "Linus Torvalds", "896.696.110-08", "torvalds@mail.com", "123");
		Cliente cli2 = new Cliente(null, "Alberto Nogueira", "169.102.580-10", "nogueira@mail.com", "173");
		Cliente cli3 = new Cliente(null, "Vinicius Sousa", "919.143.850-04", "vinicius@mail.com", "876");
		Cliente cli4 = new Cliente(null, "Guilherme Felipe", "987.218.270-10", "guilherme@mail.com", "116");
		Cliente cli5 = new Cliente(null, "Fabio Motta", "926.998.990-97", "motta@mail.com", "321");
		Cliente cli6 = new Cliente(null, "Tobias Karyl", "652.289.620-69", "karyl@mail.com", "653");
